...
const Reply = (reply:reply) => {
    ...
    //get most up to date poster display name and image
    useEffect(() => {
        axios.get(`${import.meta.env.REACT_APP_BACKEND_ROOT}/users/${reply.posterId}`)
    ...
    <div className="reply-thumbnail">
        <div className="reply-body">
            ...
            <div className="user-reply-info">
                ...
                <h4>{`${user.displayName} : ${reply.timestamp}`}</h4>
